    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "UserName", "NormalizedUserName", "Email", "NormalizedEmail", "EmailConfirmed", "PasswordHash", "SecurityStamp", "ConcurrencyStamp", "PhoneNumberConfirmed", "TwoFactorEnabled", "LockoutEnabled", "AccessFailedCount" },
                values: new object[] { regularUserId, regularUserEmail, regularUserEmail.ToUpper(), regularUserEmail, regularUserEmail.ToUpper(), true, regularUserHashedPassword, Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), false, false, true, 0 }
            );
